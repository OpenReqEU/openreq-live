...
public class ProjectController {
	...
	public String generateHelsinkiProject(HttpServletRequest request, Authentication authentication) {
		...
		try {
            ...
            Date deadlineOfRelease1 = dateformat.parse("2018-10-31");
            Date deadlineOfRelease2 = dateformat.parse("2018-12-31");
            Date deadlineOfRelease3 = dateformat.parse("2019-01-31");
